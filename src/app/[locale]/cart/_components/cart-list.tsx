...
export default function CartList() {
  ...
  return (
    <div className="flex flex-col gap-6 pt-16 max-w-3xl w-full">
      ...
      <Button
        onClick={() => router.push('/')}
        className="w-[213px] h-[41px] flex items-center justify-center gap-[10px] rounded-[10px] px-[16px] py-[10px] bg-[#A6252A] text-white font-medium text-[14px] leading-[100%] hover:opacity-90 transition"
      >
