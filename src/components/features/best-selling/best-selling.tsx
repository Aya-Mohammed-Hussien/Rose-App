        ...
        <div className="grid grid-cols-4 gap-9">
          ...
          <aside className="col-span-1 flex flex-col gap-2    ">
            ...
            <p className="text-zinc-500">
              Not sure what to choose? Start with our best sellers, these are the gifts our
              customers keep coming back for. Whether you're celebrating a birthday, anniversary or
              wedding, our top picks are guaranteed to leave a lasting impression.{' '}
            </p>
