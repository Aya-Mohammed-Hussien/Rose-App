...
const buttonVariants = cva(
  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap capitalize rounded-[0.625rem] text-base font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
        ...
        subscribe:
          ...
          'dark:bg-maroon-300 dark:text-zinc-800', // dark modeو
        customMaroon:
          'bg-[#A6252A] hover:bg-[#A6252A] text-white gap-2 text-sm',


        redSoft:
          'bg-red-100 border-red-100 text-red-600 hover:bg-red-100 hover:text-red-700 gap-1',


        blueSoft:
          'bg-blue-100 border-blue-100 text-blue-600 hover:bg-blue-100 hover:text-blue-700 gap-1',
      },
      size: {
...
// :bulb: Button component definition
